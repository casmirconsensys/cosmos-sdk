...
import (
	...
	"github.com/cosmos/cosmos-sdk/x/nbachain"
)

// NBA2ChainID hardcoded chainID for nbachain
const NBA2ChainID = "nbachain-app"
...
func GenTx(msgs []sdk.Msg, feeAmt sdk.Coins, chainID string, accnums []uint64, seq []uint64, priv ...crypto.PrivKey) auth.StdTx {
	...
	memo := nbachain.RandStringOfLength(r, nbachain.RandIntBetween(r, 0, 100))
